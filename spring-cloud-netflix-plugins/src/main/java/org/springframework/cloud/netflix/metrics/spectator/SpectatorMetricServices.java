...
public class SpectatorMetricServices implements CounterService, GaugeService {
    ...
    private void incrementInternal(String name, long value) {
        if(name.startsWith("status.")) {
            // drop this metric since we are capturing it already with SpectatorHandlerInterceptor,
            // and we are able to glean more information like exceptionType from that mechanism than what
            // boot provides us
